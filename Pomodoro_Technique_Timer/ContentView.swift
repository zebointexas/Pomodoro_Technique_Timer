...
struct ContentView: View {
    @State private var workTimeTotal = 25 * 60      // Work time in seconds
    @State private var breakTimeTotal = 5 * 60      // Regular break in seconds
    @State private var longBreakTimeTotal = 20 * 60 // Long break after 4 sessions
    @State private var currentWorkTime = 25 * 60
    @State private var currentBreakTime = 5 * 60
